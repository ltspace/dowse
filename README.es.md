...
Ofrece tres herramientas: `search`, `preview` e `index_status`. `search` admite paginación con `limit` / `offset`, total de resultados, filtro por extensión y ordenación.
